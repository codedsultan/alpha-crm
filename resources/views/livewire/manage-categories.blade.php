            ...
            <x-dialog-modal wire:model="confirmingCategoryAdd">
                ...
                <x-slot name="content">
                    <div>
                        ...
                        <input type="text" wire:model="category.name" id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-pink-500 sm:text-sm">
