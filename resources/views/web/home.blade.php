...
>
  <div class="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
    ...
    <p class="mt-4 max-w-lg sm:text-xl/relaxed">
      Discover a World of Beauty and Elegance. Elevate Your Style at X Appointments, Where Dreams Become Reality.
         </p>
        ...
        <div class="grid gap-6 text-center p-6 md:grid-cols-3 lg:gap-12">
          <div class="mb-12 md:mb-0">
            ...
            <p class="mb-4 text-neutral-500">
              ...
              I had the most amazing experience at X! The staff were so friendly and welcoming, and my hair looked absolutely stunning. I received so many compliments after my appointment and I can't wait to go back!
            </p>
          ...
          <div class="mb-12 md:mb-0">
            ...
            <p class="mb-4 text-neutral-500">
              ...
              "I had the best haircut of my life at X! The stylist listened to exactly what I wanted and then gave me a haircut that exceeded my expectations. I felt so pampered and taken care of throughout the whole process. I can't wait to come back for my next appointment!
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
          ...
          <div class="mb-0">
            ...
            <p class="mb-4 text-neutral-500">
              ...
              "I had a last-minute hair emergency and X saved the day! The staff were able to fit me in right away and they did an amazing job. I can't thank them enough for their professionalism and expertise. I will definitely be coming back!"
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
